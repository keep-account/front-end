<template>
  <view class="flex flex-col px-4 py-4">
    <navigator
      ...
      class="flex flex-row justify-start mt-2 mb-6"
      hover-class="none"
    >
      <view class="flex flex-row justify-between w-full shadow-lg px-3 rounded-lg items-center">
        <view class="flex flex-row">
          <view class="mr-4">
            <image class="w-12 h-12 m-auto rounded-3xl" :src="user.profile.avatar" />
          </view>
          <view class="flex justify-center mb-2 flex-col">
            <text class="text-fontMain font-extrabold mb-2 text-xl">{{
        ...
        <view>
          <text class="text-fontPatch rounded border-gray px-2 py-1">修改信息</text>
        </view>
      </view>
    </navigator>
